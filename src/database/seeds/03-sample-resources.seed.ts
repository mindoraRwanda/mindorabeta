    ...
    .values([
      {
        ...
        description:
          'A simple but effective breathing technique to reduce stress and anxiety. Inhale for 4 counts, hold for 7, exhale for 8.',
        category: 'breathing',
        durationMinutes: 5,
        difficulty: 1,
      ...
      },
      {
        ...
        description:
          'A mindfulness practice where you focus attention on different parts of your body to release tension.',
      ...
      },
      {
        ...
        description:
          'Write down three things you are grateful for. This practice helps shift focus to positive aspects of life.',
        category: 'CBT',
        durationMinutes: 10,
        difficulty: 1,
      ...
      },
      {
        ...
        description:
          'Systematically tense and relax muscle groups to reduce physical tension and promote relaxation.',
        category: 'relaxation',
        durationMinutes: 20,
        difficulty: 2,
      ...
      },
      {
        ...
        description:
          'Identify and challenge negative thought patterns, replacing them with more balanced thoughts.',
        category: 'CBT',
        durationMinutes: 15,
        difficulty: 3,
      ...
      },
      {
        ...
        description:
          'A meditation practice focused on developing feelings of goodwill, kindness, and warmth towards yourself and others.',
        category: 'mindfulness',
        durationMinutes: 15,
        difficulty: 2,
