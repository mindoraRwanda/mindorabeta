 ...
 * Update progress
 */
export const updateProgress = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
 ...
 * Complete exercise
 */
export const completeExercise = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
